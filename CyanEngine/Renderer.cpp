...
inline void Renderer::CreateDirect3DDevice()
{
#if defined(_DEBUG)
...
inline void Renderer::CreateCommandQueueAndList()
{
...
inline void Renderer::CreateSwapChain()
{
	...
	HRESULT hResult = m_pdxgiFactory->MakeWindowAssociation(m_hWnd, DXGI_MWA_NO_ALT_ENTER);
#ifndef _WITH_SWAPCHAIN_FULLSCREEN_STATE
	CreateRenderTargetView();
#endif
}

inline void Renderer::CreateRtvAndDsvDescriptorHeaps()
{
...
inline void Renderer::CreateRenderTargetView()
{
	D3D12_CPU_DESCRIPTOR_HANDLE d3dRtvCPUDescriptorHandle = m_pd3dRtvDescriptorHeap->GetCPUDescriptorHandleForHeapStart();
...
inline void Renderer::CreateDepthStencilView()
{
