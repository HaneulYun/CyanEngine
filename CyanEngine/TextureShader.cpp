...
D3D12_INPUT_LAYOUT_DESC SkinnedObjectShader::CreateInputLayout()
{
	...
	pd3dInputElementDescs[4] = { "BONEINDICES", 0, DXGI_FORMAT_R32G32B32_FLOAT, 48, 20, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };
...
ID3D12RootSignature* SkinnedObjectShader::CreateGraphicsRootSignature(ID3D12Device* _device)
{
	ID3D12RootSignature* pd3dGraphicsRootSignature = NULL;
