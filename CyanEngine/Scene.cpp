...
void Scene::Render()
{
	...
	Renderer::Instance()->m_pd3dCommandList->SetPipelineState(m_pd3dPipelineState);
	Renderer::Instance()->m_pd3dCommandList->IASetPrimitiveTopology(D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
	Renderer::Instance()->m_pd3dCommandList->DrawInstanced(3, 1, 0, 0);
